...
packet = io.BytesIO()
import random
string0 = "Hello, my name is London Hoang. I want Jake Boes to raw dog fuck me. I want his cock do deep in me. I want to cum in me so deep. I want my little Indianette body to shake with orgasmic pleasure."
...
pdfmetrics.registerFont(TTFont('TestFont2', 'Hoanglondon0-Regular.ttf'))
